...
abstract class DownloaderServiceBase extends $pb.GeneratedService {
  $async.Future<$0.TriggerDownloaderResponse> triggerDownloader(
      $pb.ServerContext ctx, $0.TriggerDownloaderRequest request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'TriggerDownloader':
        return $0.TriggerDownloaderRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (methodName) {
      case 'TriggerDownloader':
        return triggerDownloader(ctx, request as $0.TriggerDownloaderRequest);
      default:
        throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
